<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="frmReport.aspx.vb" Inherits="Evaluate.frmReport" %>
...
<div class="container_12">
    <!--  =============== Start Header ===============   -->    	
        ...
        <div class="grid_8">
            <div class="title rounded"> รายงาน ปีการประเมินฯ <asp:Label runat="server" ID="lblBudgetYear"></asp:Label> </div>
        </div>
        <div class="clear"></div>
        <!-- ============= input form ============= --> 
        <div class="grid_12"> 
	        <div class="block" id="DIV1">		    
			    <fieldset class="rounded" >
				    <legend class="rounded"> รายงาน</legend>
				    <center>
...
<script src="frmReport.js" type="text/javascript"></script>